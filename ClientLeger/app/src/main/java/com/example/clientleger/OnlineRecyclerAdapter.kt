...
class OnlineRecyclerAdapter: RecyclerView.Adapter<OnlineRecyclerAdapter.ViewHolder> () {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OnlineRecyclerAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.online_card_layout, parent, false)
        return ViewHolder(v)
    }
    ...
    override fun onBindViewHolder(holder: OnlineRecyclerAdapter.ViewHolder, position: Int) {
        if (users.size != 0) {
